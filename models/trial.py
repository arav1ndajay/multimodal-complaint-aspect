...
def train_epoch(model, train_dataloader, optimizer, scheduler, loss_fct):
    ...
    for step, batch in enumerate(tqdm(train_dataloader, desc="Iteration")):
        ...
        # print('visual: ', batch[1].shape)
        # print('acoustic: ', batch[2].shape)
        # print('input_mask: ', batch[3].shape)
        # print('segment_ids: ', batch[4].shape)
        # print('hcf: ', batch[5].shape)
        # print('label_ids: ', batch[6].shape)
